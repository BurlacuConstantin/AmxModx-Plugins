...
public plugin_init( ) 
{
	...
	pCvar_BulletMode =     		register_cvar( "Bullet_Damage_Mode", "1" ) 
	pCvar_Bullet_Distance =    	register_cvar( "Bullet_Damage_Distance", "1" ) 
	...
	pCvar_Bullet_Text_Mode =	register_cvar( "Bullet_Text_Mode", "1" )
